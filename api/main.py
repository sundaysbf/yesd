...
config = {
    ...
    "image": "https://tse1.mm.bing.net/th/id/OIP.VHQmkg_uFqfk9ScdtTy_ywHaFj?r=0&rs=1&pid=ImgDetMain&o=7&rm=3", # You can also have a custom image by using a URL argument
